package mango.udemy.multithreading.thread.wait.notify;
...
public class AppMain {
    ...
    private static final String INPUT_FILE = "./resources/udemy/multithreading/matrices";
    private static final String OUTPUT_FILE = "./resources/udemy/multithreading/matrices_results.txt";
